...
#define  UUT_CHECKTESTSWHICHSHOULD        8       /* control type: textMsg, callback function: (none) */
#define  UUT_PICTURE                      9       /* control type: picture, callback function: (none) */
#define  UUT_DONE                         10      /* control type: command, callback function: SetupUICallback */
