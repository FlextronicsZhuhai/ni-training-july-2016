...
This example has limited functionality for demonstrational purposes and is not intended for use in real applications without modification.
Refer to the Basic User Interface TestStand help topic for more information on using this example.
*/
