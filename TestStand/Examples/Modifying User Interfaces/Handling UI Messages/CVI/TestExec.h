...
#define  MAINPANEL_SEQ_STATUS             10      /* control type: string, callback function: (none) */
#define  MAINPANEL_SHOW_SEQ_DLGS          11      /* control type: radioButton, callback function: (none) */
